...
word=c('marketting','consumer','demand','price','analytics','data','information','stock','investment','analytics','data scientist','satisfaction','queries','data mining','data bases','operations','major','minor','feed back','discounts','delivery','R','Python')
word
freq=c(30,20,15,36,23,88,10,20,30,120,16,18,28,20,40,400,100,90,120)
freq

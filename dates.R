...
#find out when i was born
dob="13-11-1992"
date_dob=as.Date(dob,format="%d-%m-%Y")
date_dob
format(date_dob,format("%A"))
#days passed since i was born
Sys.Date()-date_dob
#days passed from birth to joining MBA
as.Date("08-08-2018",format="%d-%m-%Y")- date_dob

#me and my friend
as.Date("13-11-1992",format="%d-%m-%Y")
